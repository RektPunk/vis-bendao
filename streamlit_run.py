...
if len(st.session_state.transactions) != 0:
    ...
    if _df is None:
        ...
        # balance_vis_builder.configure_selection(
        #     "multiple",
        #     use_checkbox=True,
        #     groupSelectsChildren="Group checkbox select children",
        # )
        ...
        if len(_selected_df) != 0:
            ...
            _selected_balance_df = get_loss_gain(_selected_df)
            selected_balance_vis_builder = GridOptionsBuilder.from_dataframe(_selected_balance_df)
            selected_balance_vis_builder.configure_pagination(paginationAutoPageSize=True)
